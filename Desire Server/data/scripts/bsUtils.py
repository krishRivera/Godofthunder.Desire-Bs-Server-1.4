...
gTips = ["Server script by Desire","script by scanner"]
...
class Background(bsGame.Actor):
    ...
    def __init__(self, fadeTime=500, startFaded=False, showLogo=False):
        ...
        with bs.Context(session):
            ...
            if showLogo:
                logoTexture = random.choice([bs.getTexture('coin'),bs.getTexture('logo'),bs.getTexture('chestIcon'),bs.getTexture('logoEaster')])
