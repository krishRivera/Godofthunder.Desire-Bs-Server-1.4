...
class Cannon(bs.Actor):
    ...
    def __init__(self, position=(0, 1, 0), velocity=(0, 0, 0), angle=0,
        ...
        self.vel = velocity
        self.owner = owner
        self.cannonModel = bs.getModel('tnt')
        self.cannonTex = bs.getTexture('achievementWall')
...
class Clay(bs.Actor):
    ...
    def __init__(self, position=(0, 1, 0), velocity=(0, 0, 0),
        ...
        if banana:
            bs.gameTimer(800+random.randint(0, 500), bs.Call(self.explode))
