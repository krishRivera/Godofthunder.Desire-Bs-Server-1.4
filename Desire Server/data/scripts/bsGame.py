...
class Activity(object):
    ...
    def onBegin(self):
        ...
        def text():
                #bySoby
                S = bs.newNode('text',
                       attrs={ 'text':u'\xa9 Script By Desire',
                              'scale':0.9,
                              'maxWidth':0,
                              'position':(1,5),
                              'shadow':0,
                              ...
                              'hAlign':'center',
                              'vrDepth': -10,})
                bs.animate(S,'opacity',{0: 0.0,500: 1.0,6500: 1.0,7000: 0.0})
                bs.gameTimer(7000,S.delete)

                S = bs.newNode('text',
                       attrs={ 'text':u'\xa9 Script By Scanner',
                              'scale':0.9,
                              'maxWidth':0,
                              'position':(1,5),
                              'shadow':0,
                              ...
                              'hAlign':'center',
                              'vrDepth': -10,})
                bs.animate(S,'opacity',{8500: 0.0,9000: 1.0,14500: 1.0,15000: 0.0})
                bs.gameTimer(15000,S.delete)

                S = bs.newNode('text',
                       attrs={ 'text':u'Discord id .scanner.',
                              'scale':0.9,
                              'maxWidth':0,
                              'position':(1,5),
                              'shadow':0,
                              ...
                              'hAlign':'center',
                              'vrDepth': -10,})
                bs.animate(S,'opacity',{17500: 0.0,18500: 1.0,24500: 1.0,25000: 0.0})
                bs.gameTimer(25000,S.delete)
        bs.gameTimer(100,bs.Call(text))
        bs.gameTimer(27000,bs.Call(text),repeat = True)
